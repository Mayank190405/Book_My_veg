...
exports.AVAILABLE_TRIGGER_EVENTS = [
    ...
    },
    {
        ...
        description: "Triggered immediately when customer places an order.",
        category: "Orders",
        defaultDurationValue: 0,
        defaultDurationUnit: "MINUTES",
        availableVariables: [
            { key: "customer.name", label: "Customer Name" },
            { key: "order.id", label: "Order ID (#123)" },
            { key: "order.totalAmount", label: "Total Order Value (₹)" }
        ]
    },
    {
        key: "PAYMENT_RECEIVED",
        label: "Payment Received Confirmation",
        description: "Triggered when a payment transaction is successfully recorded.",
        category: "Billing",
        defaultDurationValue: 0,
        defaultDurationUnit: "MINUTES",
        availableVariables: [
            { key: "customer.name", label: "Customer Name" },
            { key: "order.id", label: "Invoice / Order No." },
            { key: "payment.amount", label: "Amount Paid (₹)" },
            { key: "payment.mode", label: "Payment Mode (UPI/Cash/Card)" }
        ]
    },
    {
        key: "FEEDBACK_REQUEST",
        label: "Customer Feedback Request",
        description: "Triggered after an order is delivered to collect customer review.",
        category: "Marketing & Retention",
        defaultDurationValue: 3,
        defaultDurationUnit: "HOURS",
        availableVariables: [
            { key: "customer.name", label: "Customer Name" },
            { key: "feedback.link", label: "Feedback Form Link" }
        ]
    }
];
/**
...
const getAvailableTemplates = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const defaultTemplates = [
            {
                ...
                variablesCount: 5,
                exampleVariables: ["Customer", "1001", "450", "Cash", "https://bookmyveg.co.in/invoice/1001"]
            },
            {
                ...
                variablesCount: 6,
                exampleVariables: ["Customer", "1001", "1200", "500", "https://bookmyveg.co.in/invoice/1001", "https://bookmyveg.co.in/pay?id=1001"]
            },
            {
                ...
                variablesCount: 4,
                exampleVariables: ["Customer", "500", "1001", "https://bookmyveg.co.in/pay?id=1001"]
            },
            {
                ...
                variablesCount: 4,
                exampleVariables: ["Customer", "Book My Veg", "7", "https://bookmyveg.co.in"]
            },
            {
                ...
                variablesCount: 7,
                exampleVariables: ["Vendor", "PO-101", "12", "15000", "Main Hub", "Store Address", "https://bookmyveg.co.in/po/101"]
            },
            {
                ...
                variablesCount: 3,
                exampleVariables: ["Customer", "1001", "450"]
            },
            {
                ...
                variablesCount: 2,
                exampleVariables: ["Customer", "https://bookmyveg.co.in/feedback?orderId=1001"]
            },
            {
                name: "login",
        ...
        liveTemplates.forEach(t => {
            ...
            if (name) {
                const bodyComponent = (_a = t.components) === null || _a === void 0 ? void 0 : _a.find((c) => c.type === "BODY");
                const headerComponent = (_b = t.components) === null || _b === void 0 ? void 0 : _b.find((c) => c.type === "HEADER");
                const buttonsComponent = (_c = t.components) === null || _c === void 0 ? void 0 : _c.find((c) => c.type === "BUTTONS");
                const bodyText = (bodyComponent === null || bodyComponent === void 0 ? void 0 : bodyComponent.text) || t.body || t.content || t.template_text || `Template: ${name}`;
                const matches = bodyText.match(/{{\d+}}/g);
                const variablesCount = matches ? matches.length : 0;
                const exampleVariables = ((_e = (_d = bodyComponent === null || bodyComponent === void 0 ? void 0 : bodyComponent.example) === null || _d === void 0 ? void 0 : _d.body_text) === null || _e === void 0 ? void 0 : _e[0]) || [];
                mergedMap.set(name, {
                    id: t.id,
                    name,
                    ...
                    variablesCount,
                    exampleVariables,
                    header: (headerComponent === null || headerComponent === void 0 ? void 0 : headerComponent.text) || null,
                    buttons: (buttonsComponent === null || buttonsComponent === void 0 ? void 0 : buttonsComponent.buttons) || [],
                    raw: t
                });
            }
        });
