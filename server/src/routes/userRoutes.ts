...
router.post("/admin/bulk-ingest", authenticate, authorize(["ADMIN", "STORE_ADMIN", "MANAGER"]), bulkIngestUsers);
router.get("/admin/drivers", authenticate, authorize(["ADMIN", "STORE_ADMIN", "MANAGER"]), getDeliveryPartners);
