...
export function normalizeUnit(unitStr: string | null | undefined): string {
    if (!unitStr) return "GM";
    const u = unitStr.trim().toUpperCase();

    if (u === "KG" || u === "KILOGRAM" || u === "KILOGRAMS") return "KG";
    if (u === "G" || u === "GM" || u === "GRAM" || u === "GRAMS") return "GM";
    if (u === "LTR" || u === "LITER" || u === "LITRE" || u === "LITRES") return "LTR";
    if (u === "ML" || u === "MILLILITER" || u === "MILLILITERS") return "ML";
    if (u === "PIECE" || u === "PCS" || u === "PC" || u === "PIECES") return "PIECE";
    if (u === "PACKET" || u === "PKT" || u === "PACK" || u === "PACKETS" || u === "PKTS") return "PACKET";
 ...
 */
export function convertVariantToBaseQuantity(
    variantWeight: number | null | undefined,
    variantUnitRaw: string | null | undefined,
    baseUnitRaw: string | null | undefined,
    itemCount: number = 1
): number {
 ...
 */
export function calculateAvailablePackStock(
    baseStock: number,
    variantWeight: number | null | undefined,
    variantUnitRaw: string | null | undefined,
    baseUnitRaw: string | null | undefined
    ...
    if (baseConsumedPerPack <= 0) return 0;
